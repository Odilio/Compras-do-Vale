...
public class calculoFreteCorreio {
	public static void main(String[] args) {
		...
		String nCdEmpresa = "";
		String sDsSenha = ""; 
		String nCdServico = "40010"; //  PAC - 41106  SEDEX - 40010
		String sCepOrigem = "60055360";
	...
	public String calcularFrete(String cep, int quantidade,String servico){
	
	// Dados pesquisa		
			String nCdEmpresa = "";
			String sDsSenha = ""; 
			String nCdServico = servico;//  PAC - 41106  SEDEX - 40010
			String sCepOrigem = "60055360";
			String sCepDestino = cep;
			Double peso = 0.060 * quantidade;
			String nVlPeso = peso+"";
			String nCdFormato = "1";
			String nVlComprimento = "20";
			String nVlAltura = "5";
	...
	public String calcularFreteVale(String cep, int quantidade,String servico){
		return servico;
