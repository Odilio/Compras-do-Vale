(function (global, factory) {
    ...
    var hr = _moment__default.defineLocale('hr', {
        months : 'sijecanj_veljaca_ožujak_travanj_svibanj_lipanj_srpanj_kolovoz_rujan_listopad_studeni_prosinac'.split('_'),
    ...
    function lt__monthsCaseReplace(m, format) {
        var months = {
                'nominative': 'sausis_vasaris_kovas_balandis_geguže_birželis_liepa_rugpjutis_rugsejis_spalis_lapkritis_gruodis'.split('_'),
                'accusative': 'sausio_vasario_kovo_balandžio_gegužes_birželio_liepos_rugpjucio_rugsejo_spalio_lapkricio_gruodžio'.split('_')
            },
            nounCase = (/D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/).test(format) ?
                'accusative' :
                'nominative';
    ...
    //! author : Janis Elmeris : https://github.com/JanisE
    ...
    //! author : Miodrag Nikac <miodrag@restartit.me> : https://github.com/miodragnikac
    ...
    var me = _moment__default.defineLocale('me', {
        ...
        weekdays: ['nedjelja', 'ponedjeljak', 'utorak', 'srijeda', 'cetvrtak', 'petak', 'subota'],
